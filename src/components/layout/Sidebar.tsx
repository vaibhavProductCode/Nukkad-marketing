  ...
  return (
    <aside className="hidden md:flex flex-col w-56 bg-[#1e293b] min-h-screen fixed left-0 top-0 z-40">
      <div className="px-5 py-5 border-b border-slate-700">
        <Link href={`/${locale}`}>
          <span className="text-2xl font-black text-[#FF6B35]">NUKKAD</span>
        </Link>
        <p className="text-xs text-slate-400 mt-0.5">Marketing in 3 taps</p>
      </div>
      ...
      <div className="px-4 pb-5 border-t border-slate-700 pt-4">
        <div className="bg-[#FF6B35]/10 rounded-xl p-3 mb-3">
